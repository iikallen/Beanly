...
def test_openapi_contains_current_contract() -> None:
    ...
    assert {
        ...
        "/api/v1/integrations/connections/{connection_id}/disconnect",
        "/api/v1/integrations/connections/{connection_id}/locations/{location_id}",
        "/api/v1/integrations/jobs",
        "/api/v1/integrations/jobs/{job_id}/retry",
        "/api/v1/integrations/webhooks/{provider_code}/{connection_id}",
        "/api/v1/integrations/providers/{provider_code}/oauth/start",
        "/api/v1/integrations/oauth/{provider_code}/callback",
        "/api/v1/employees",
