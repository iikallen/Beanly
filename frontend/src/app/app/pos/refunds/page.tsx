...
export default function RefundHistoryPage() {
  ...
  const estimatedTotal = selectedOrder ? refundDraftTotal(selectedOrder, quantities) : BigInt(0);
  ...
  function changeQuantity(itemId: string, value: number) {
    ...
    const total = refundDraftTotal(selectedOrder, next);
