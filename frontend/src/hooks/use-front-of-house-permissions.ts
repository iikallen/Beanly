...
export function useFrontOfHousePermissions() {
  ...
  return {
    loading,
    canRead: permissions.includes("foh.read"),
    canManage: permissions.includes("foh.manage"),
    canConfigure: permissions.includes("foh.configure"),
  };
}
